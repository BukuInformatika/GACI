...
\end{lstlisting}
	...
	\item Edit beberapa codingan yang sudah dipastekan tadi dari assets/index.html ke application/views/dasboard.php sesuai dengan tampilan yang diinginkan. Apabila memisahkan header dan footer jangan lupa untuk memanggil header footer. Berikut codingan full dari dasboard.php:
\begin{lstlisting}
...
\end{lstlisting}
	    \par Load view berarti meload file yang ada di dalam folder view, dalam artian codingan diatas akan meload file header yang ada di folder application/views/page/header, begitu pun dengan file footer.php. Simpan semua konfigurasi dan coba jalankan.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Pada tahap inin saya akan membuat model untuk table barang, berikut codingan yang saya gunakan:
\begin{lstlisting}
<?php
